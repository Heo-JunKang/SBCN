...
@section('content')
	<div class="site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}002/images/img_main_bg.jpg);" data-aos="fade" id="home-section">
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-md-12 mt-lg-5 text-center">
					<p style="color:#fff;" class="mb-5">주식하며 스트레스 받는 당신.. <br />저희가 흑기사가 되어 드리겠습니다</p>

					<div class="cta-big-image mb-3">
						<img class="img-fluid" src="{{config_item('new_landing_url')}}002/images/img_main_title.png" style="max-width:70%"/>
					</div>
					<div class="cta-big-image">
						<img class="img-fluid" src="{{config_item('new_landing_url')}}002/images/img_main.png" style="max-width:100%"/>
					</div>
				</div>
			</div>
		</div>
	...
	<section>
		...
		<div class="youtubeWrap">
			<iframe width="500" height="405" src="https://www.youtube.com/embed/IkCZkBn02uU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>
	...
	<section class="site-section testimonial-wrap" id="testimonials-section">
		<div class="slide-one-item home-slider owl-carousel">
			<div class="">
				<div class="">
					<div class="site-blocks-cover overlay" style="background:#ededed;" data-aos="fade" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-12 mt-lg-5 text-center">
									<img src="{{config_item('new_landing_url')}}002/images/img_slide01_contents.png" class="img-fluid"/>
								</div>
							</div>
						</div>
					</div>
			...
			<div>
				<div class="testimonial">
					<div class=" site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}002/images/img_slide02.jpg);" data-aos="fade" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-12 mt-lg-5 text-center">
									<h1>마이너스가 된 당신의 계좌?<br />큰 수익이 나지 않는 당신의 계좌?</h1>
									<img src="{{config_item('new_landing_url')}}002/images/img_slide02_contents.png" class="img-fluid"/>
								</div>
							</div>
						</div>
					</div>
			...
			<div>
				<div class="testimonial">
					<div class="site-blocks-cover overlay" style="background:#1c1c1c;" data-aos="fade" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-12 mt-lg-5 text-center">
									<p>금융·증권 전문방송 itbc가 선택한 최강의 전문가들이</p>
									<h1>당신의 삶을 바꿔드리겠습니다</h1>
									<img src="{{config_item('new_landing_url')}}002/images/img_slide03_contents.png" class="img-fluid"/>
								</div>
							</div>
						</div>
					</div>
			...
			<div>
				<div class="testimonial">
					<div class="site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}002/images/img_slide04.jpg);" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-12 mt-lg-5 text-center">
									<h1>행복은 멀리 있지 않습니다</h1>
									<p>itbc스탁이 당신을 웃음짓게 해드리겠습니다</p>
								</div>
							</div>
						</div>
					</div>
	...
	<section class="site-section" id="blog-section" style="background:#ed1c24;">
		<div class="container">
			<div class="row">
				<div class="col-12 text-center  mt-5 mb-5">
					<h2 class="section-title mb-3">혼자 고민하지 마세요 itbc스탁이 돕겠습니다</h2>
		...
		<div class="container">
			<div class="row pt-5 mb-5">
				<div class="col-12 text-center">
					...
					<h2 class="section-title mb-3" style="color:#1c1c1c;">인공지능이 포착한 급등종목<br /> <span>지금 무료로 받아가세요</span></h2>
				</div>
			</div>
			<div class="row form-group">
				<div class="col-md-12 mb-5">
					<form id="create-experience" method="post" action="/experience" onsubmit="return false;" class="p-3 bg-white">
						...
						<input type="hidden" name="landing_num" id="landing_num" value="002">
