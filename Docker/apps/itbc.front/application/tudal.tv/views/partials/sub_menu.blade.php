        ...
        <div class="sub-fix-in">
            ...
            <div class="tab">
                <ul>
                    ...
                    <li class="nav-items {{convert_value($uri[2],'stock-check','on')}}"><a href="/invest/stock-check"><span>실시간시황</span></a></li>
                    <li class="nav-items {{convert_value($uri[2],'result-news','on')}}"><a href="/invest/result-news"><span>실적속보</span></a></li>
                    ...
                    <li class="nav-items {{convert_value($uri[2],'main-news','on')}}"><a href="/invest/main-news"><span>주요뉴스</span></a></li>
                </ul>
            </div>
        </div>
    </div>
