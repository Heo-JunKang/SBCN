...
@push('css')
	...
	<style>
		...
		.section-title {
			...
			font-size: 40px;
			font-weight: 900; }
		.section-title span{color:#ed1c24;}
		@media (max-width: 991.98px) {
			.section-title {
				font-size: 30px; } }
...
@section('content')
	<div class="site-blocks-cover overlay" style="background:#574494;" data-aos="fade" id="home-section">
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-md-8 mt-lg-5 text-center">
					<h1>인공지능과 함께 시장을 정복하라!</h1>
					<p class="mt-4 mb-4" style="color:#b8aeda;font-weight:bold;">세상을 바꿀 자동매매 솔루션</p>
					<div class="cta-big-image">
						<img class="img-fluid" src="{{config_item('new_landing_url')}}005/images/img_alphaon_logo.png" style="max-width:50%"/>
					</div>
					<h3 class="mt-3 mb-3" style="color:white;">알파온 트레이더</h3>
					<div class="cta-big-image">
						<img class="img-fluid" src="{{config_item('new_landing_url')}}005/images/img_main.png" />
					</div>
					<!-- <div> -->
	...
	<section class="site-section testimonial-wrap" id="testimonials-section">
		<div class="slide-one-item home-slider owl-carousel">
			<div class="">
				<div class="">
					<div class="site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}005/images/img_slide01.jpg);" data-aos="fade" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-8 mt-lg-5 text-center">
									<h1>주식초보도 전문가처럼</h1>
									<p class="mb-5" style="color:white;">도저히 모르겠다면 인공지능과 전문가가<br />제공하는 포트폴리오 그대로 투자하면 <br />주식 초보도 고수들 처럼 수익을 거둬 갈 수 있어요</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div>
				<div class="testimonial">
					<div class=" site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}005/images/img_slide02.jpg);" data-aos="fade" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-8 mt-lg-5 text-center">
									<h1>당신이 꿈꾸던 순간이 현실로</h1>
									<p class="mb-5" style="color:white;">거래는 알파온 트레이더에게 맡기고<br />자신의 삶을 살아가세요</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div>
				<div class="testimonial">
					<div class="site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}005/images/img_slide03.jpg);" data-aos="fade" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-8 mt-lg-5 text-center">
									<h1>미래의 수익이 한 눈에</h1>
									<p class="mb-5" style="color:white;">실시간 인기종목 확인으로 더 높은 수익을 가져가세요</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div>
				<div class="testimonial">
					<div class="site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}005/images/img_slide04.jpg);" id="home-section">
						<div class="container">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-8 mt-lg-5 text-center">
									<img src="{{config_item('new_landing_url')}}005/images/img_slide04_contents.png" class="img-fluid"/>
								</div>
							</div>
						</div>
					</div>
	...
	<section>
		...
		<div class="youtubeWrap">
			<iframe width="500" height="315" src="https://www.youtube.com/embed/SwrVvNfjS50" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>

	</section>

	<section class="site-section" id="blog-section" style="background:#292929;">
		<div class="container">
			<div class="row">
				<div class="col-12 text-center  mt-5 mb-5">
					<h2 class="section-title mb-3"><span>알파온 트레이더</span>로 주식 시장을 쉽고 빠르게 정복해보세요</h2>
					<h3 class="section-sub-title">투자 결과는 개인에 따라 달라질 수 있습니다</h3>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row pt-5 mb-5">
				<div class="col-12 text-center">
					...
					<h2 class="section-title mb-3" style="color:#1c1c1c;">알파온 트레이더 <span>무료체험신청</span></h2>
				</div>
			</div>
			<div class="row form-group">
				<div class="col-md-12 mb-5">
					...
					<form id="create-experience" method="post" action="/experience" onsubmit="return false;" class="p-3 bg-white">
						...
						<input type="hidden" name="landing_num" id="landing_num" value="005">
						...
						<div class="row form-group">
							<div class="col-md-12">
								<input type="button" href="javascript:void(0);" onclick="post_experience();" class="btn btn-primary btn-md text-white" value="무료체험 신청하기">
							</div>
						</div>
