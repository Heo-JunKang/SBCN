...
@section('content')
  <div class="site-wrap">
    <!-- S : Form -->
    <section class="site-section bg-light" id="contact-section" style="background-image:url({{config_item('image_url')}}landing/012/img_landing_12.png)!important;">
      <div class="container">
        <div class="row pt-5 mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3" style="color:white;">itbcstock<br />계좌 회복 프로젝트 <br/><strong style="color:red;">무료</strong> 참여하기</h2>
          </div>
        </div>
        <div class="row form-group" style="margin-bottom: 0px;">
          <div class="col-md-12 mb-5">
            <form id="create-experience" method="post" action="/experience" onsubmit="return false;" class="p-3 bg-white">
              ...
              <input type="hidden" name="landing_num" id="landing_num" value="012">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="button" href="javascript:void(0);" onclick="post_experience();" value="무료 참여 신청" class="btn btn-primary btn-md text-white">
                </div>
              </div>
