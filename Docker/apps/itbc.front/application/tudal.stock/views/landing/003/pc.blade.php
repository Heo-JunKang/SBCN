...
@push('css')
	...
	<style>
		...
		* {
		...
		/* 메인 비디오  CSS */
		.main_video{width: 100%;display:block;margin:0 auto;background:#000;text-align:center;}
		...
		.mainc{width:980px;margin:0 auto;}
	</style>
@endpush
...
<body>
	...
	<!-- page loading image -->
		<div class="main_banner">
			<img src="{{$landing_img_url}}img_main.jpg" alt="딥러닝 알고리즘으로 주식시장을 정복한다">
		</div>
		<div class="home__slider">
			<div class="bxslider">
				<div class=""><img src="{{$landing_img_url}}img_slide01.jpg"/></div>
				<div class=""><img src="{{$landing_img_url}}img_slide02.jpg" /></div>
				<div class=""><img src="{{$landing_img_url}}img_slide03.jpg" /></div>
				<div class=""><img src="{{$landing_img_url}}img_slide04.jpg" /></div>
			</div>
		</div>
		<div class="main_banner02">
			<img src="{{$landing_img_url}}img_con01.jpg" alt="혼자 고민하지 마세요 itbc스탁이 돕겠습니다"/>
		</div>
	</div>
	<!-- write-area -->
			...
			<div class="write-area-wrap">
				...
				<div class="myinfor">
					<form id="create-experience" method="post" action="/experience" onsubmit="return false;">
						...
						<input type="hidden" name="landing_num" id="landing_num" value="003">
								...
								@foreach($policy->contents->items as $v)
									...
									<li>
										...
										<span class="mk-fromput">
											...
											<label for="mk-check-ver-1{{$v->policy_id}}" class="label02" style="height:30px;"></label>
											<span class="labeltxt2" style="padding:10px;">{{$v->title}}({{$require_label}})</span>
										</span>
									</li>
								@endforeach
							</ol>
