...
@push('css')
    ...
    <style>
      ...
      .site-bg{
        ...
        background-image:url({{config_item('new_landing_url')}}009/images/img_bg_1.jpg);
      }
      .site-section {
        padding: 2.5em 0; }
...
@section('content')
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#team-section" class="nav-link">주요 수익률</a></li>
                <li><a href="#services-section" class="nav-link">세가지 약속</a></li>
                <li><a href="#manage-section" class="nav-link">고객과의 눈맞춤</a></li>
              </ul>
            </nav>
          </div>
   ...
   <!-- S: Main 전문가 부분 -->
            ...
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>파스칼</li>
                  <li>김재윤 전문가</li>
                  <li>전) 솔라스탁 대표이사 <br />실전투자경력 13년</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_01.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>꽃길</li>
                  <li>사근종 전문가</li>
                  <li>이데일리TV 베테랑라이브 출연<br />전) 아시아경제연구소 애널리스트 팀장</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_02.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>아이린</li>
                  <li>정유진 전문가</li>
                  <li>실전투자경력 10년<br />증권·펀드 파생상품<br />투자권유자문 보유</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_03.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>이프로</li>
                  <li>이효열 전문가</li>
                  <li>전) MTN 시황 브리핑<br />전) 동부증권 PB</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_04.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>라이언김</li>
                  <li>김상현 전문가</li>
                  <li>투자자산운용사 보유<br />신한금융투자그룹 투자대회 1위</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_05.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>투자도깨비</li>
                  <li>안태일 전문가</li>
                  <li>금융공학 MBA 석사<br />SBSCNBC 수익률대회 1위</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_06.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                 <li>인공지능</li>
                  <li>AI-스마트모멘텀</li>
                  <li>한국경제TV 수익률 빅매치<br />종목수익률 1위 <br />RA테스트베드 인증</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_07.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		   <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>자동매매프로그램</li>
                  <li>알파온트레이더</li>
                  <li>RA 테스트베드 안정성 부문 1위 <br />인공 지능을 통한 자동매매</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_08.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">            
                <img src="{{config_item('new_landing_url')}}009/images/main-title01.png" alt="Image" class="img-fluid">
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">            
                <img src="{{config_item('new_landing_url')}}009/images/main-title02.png" alt="Image" class="img-fluid">
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>주식사부</li>
                  <li>전정현 전문가</li>
                  <li>전) 동서증권<br />전) 이토마토 증권방송 애널리스트</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_09.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>Trader J</li>
                  <li>이영재 전문가</li>
                  <li>투자자산운용사 보유<br />전) Npic투자클럽 주식운용팀</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_10.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>조박사</li>
                  <li>조성일 전문가</li>
                  <li>전) 삼성증권 PB<br />위탁자금 250억 운용경력</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_11.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                   <li>시스템트레이더</li>
                  <li>김대호 전문가</li>
                  <li>전) NH투자증권 FA<br />주식, 외환, 인공지능 논문 다수 집필</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_12.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>권차트</li>
                  <li>권오각 전문가</li>
                  <li>해외 선물 옵션 트레이더 출신<br />한국투자증권 수익률 대회 3위</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_13.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                 <li>불나방</li>
                  <li>김성은 전문가</li>
                  <li>실전투자경력 7년<br />선물옵션 트레이더 출신</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_14.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>상승클럽</li>
                  <li>강대혁 전문가</li>
                  <li>실전 투자경력 15년<br />투자클럽 대표전문가</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_15.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
		  <div class="col-6 col-sm-6 col-md-6 col-lg-2 col-xl-2" style="padding:0;">
            <div class="team-member">
              <figure>
                <ul class="social">
                  <li>슈팅클럽</li>
                  <li>이수범 전문가</li>
                  <li>실전투자경력 14년<br />증권투자상담사 보유</li>
                </ul>
                <img src="{{config_item('new_landing_url')}}009/images/expert_16.png" alt="Image" class="img-fluid">
              </figure>
            </div>
          </div>
       </div> <!-- row -->
    ...
    <!-- S : contents 01  -->
    <section class="section pb-0" style="background:#31b2ae;" >
      <div class="container">
        <div class="row check-availabilty" id="next">
          <div class="block-32" data-aos="fade-up" data-aos-offset="-200">

            <div class="row ">
              <h3 class="dbtitle col-lg-12 text-center mb-5 mt_in">3일이면 충분합니다 <span>지금 경험해보세요!</span></h3>
            </div>
            <form id="create-experience" method="post" action="/experience" onsubmit="return false;">
              ...
              <input type="hidden" name="landing_num" id="landing_num" value="009">
        ...
        <div class="container">
            <div class="mt-5 mb-5">
                <div class="col-12" style="padding:5rem 0;">
                    ...
                    <h3 style="color:#fff;">
                        <p class="col-md-12 text-center">손실이 너무 크지 않으세요?<br />어떤 종목을 사야 할지 모르시겠나요?</p>
                    </h3>
                </div>
            </div>
        </div>
   ...
   <section>
		<div class="site-section cta-big-image" id="about-section" style="padding:0;">
		  <div class="titleWrap" style="background:#ff3737;">
			<div class="mt_out">
				<a href="#contact-section">
				<div class="mt_in">
					<span>itbcstock의 전문가들이<br />당신에게 숨겨진 수익 본능을 깨워드립니다</div>
				</a>
			</div>
		  </div>  
		</div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12 text-center">
            <h2 class="section-title mb-3" style="color:#000;">itbcstock은 수익으로 증명하고 있습니다</h2>
            <p class="col-md-12 text-center">전문가들이 거둔 실제 매매 수익입니다</p>
          </div>
        </div>
        <div class="row">    
          <div class="col-md-4 col-6 mb-4 ">
            <div class="team-member">
              <figure>               
                <img src="{{config_item('new_landing_url')}}009/images/profit01.png" alt="Image" class="img-fluid">
              </figure>              
            </div>
          </div>
		  <div class="col-md-4 col-6 mb-4">
            <div class="team-member">
              <figure>               
                <img src="{{config_item('new_landing_url')}}009/images/profit02.png" alt="Image" class="img-fluid">
              </figure>              
            </div>
          </div>
		  <div class="col-md-4 col-6 mb-4">
            <div class="team-member">
              <figure>               
                <img src="{{config_item('new_landing_url')}}009/images/profit03.png" alt="Image" class="img-fluid">
              </figure>              
            </div>
          </div>
		  <div class="col-md-4 col-6 mb-4">
            <div class="team-member">
              <figure>               
                <img src="{{config_item('new_landing_url')}}009/images/profit04.png" alt="Image" class="img-fluid">
              </figure>              
            </div>
          </div>
		  <div class="col-md-4 col-6 mb-4">
            <div class="team-member">
              <figure>               
                <img src="{{config_item('new_landing_url')}}009/images/profit05.png" alt="Image" class="img-fluid">
              </figure>              
            </div>
          </div>
		  <div class="col-md-4 col-6 mb-4">
            <div class="team-member">
              <figure>               
                <img src="{{config_item('new_landing_url')}}009/images/profit06.png" alt="Image" class="img-fluid">
              </figure>              
            </div>
          </div>
		</div>
    ...
    <!-- S : contents 05 -->
    <section>
		<div class="site-section mb-5" id="about-section" style="padding:0;">
		  <div class="titleWrap titleWrap02 pb-3" style="background:#fff;">
			<div class="mt_out">
				<div class="mt_in">
					<span><b style="color:#31b2ae">이외 20% 이상, 10% 이상 수익 다수</b><br />너무 많아 한 그릇에 담을 수 없었습니다</div>
			</div>
		  </div>  
		</div>
	</section>	
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3" style="color:#ff3737;">itbcstock의 세가지 실천</h2>
          </div>
        </div>
	...
	<section class="site-section" id="manage-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3 mt_in" style="color:#2f2f2f;">itbcstock만의 세심한 <span >고객 관리</span></h2>
          </div>
        </div>
        ...
        <div class="row">
			<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-left">
				<div class="h-entry">
				  ...
				  <p>연구원과의 상담을 통해 자신에게<br />알맞은 전문가를 찾으세요</p>
				</div>
			</div>
			...
			<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-left">
				<div class="h-entry">
				  ...
				  <h2 class="font-size-regular" style="color:#31b2ae;font-weight:bold;">전문가 종목상담 및 리딩</h2>
				  <p>itbcstock의 전문가들이<br />여러분께 수익을 선사해드립니다</p>
				</div>
			</div>
			...
			<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-left">
				<div class="h-entry">
				 ...
				 <h2 class="font-size-regular" style="color:#31b2ae;font-weight:bold;">고객만족센터 운영</h2>
			...
			<div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-left">
				<div class="h-entry">
				 ...
				 <h2 class="font-size-regular" style="color:#31b2ae;font-weight:bold;">준법감시팀 운영</h2>
				  <p>준법감시팀 운영으로<br />어떠한 위법행위도 없도록<br />투명성을 높였습니다</p>
				</div>
			</div>
        </div>
        </div>
