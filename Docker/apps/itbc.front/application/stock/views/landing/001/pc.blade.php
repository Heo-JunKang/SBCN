...
@section('content')
    <div class="site-blocks-cover overlay" style="background-image:url({{config_item('new_landing_url')}}001/images/img_main_bg.jpg" data-aos="fade" id="home-section">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-12 mt-lg-5 text-center">
                    <h1 class="mt-3 mb-3 text-left">
                        <img class="img-fluid" src="{{config_item('new_landing_url')}}001/images/img_main_title.png">
                    </h1>

                    <h2 class="mt-5 mb-3 text-left" style="color:white;">
                        itbc스톡 <br /><span style="color:#43e7ff;font-weight:bold;"> 알파온</span> 가동!
                    </h2>
                    <!-- <div> -->
        ...
        <div class="slide-one-item home-slider owl-carousel">
                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-10 mt-lg-5 text-center">
                                    <img src="{{config_item('new_landing_url')}}001/images/img_slide01_contents.png" class="img-fluid"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <div class="testimonial">
                    <div class=" site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}001/images/img_slide02.jpg);" data-aos="fade" id="home-section">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-10 mt-lg-5 text-right">
                                    <h1>우리는 진짜 <span style="color:#fcbf2d;">인공지능</span>입니다</h1>
                                    <p class="mb-5" style="color:white;">
                                        연구기간 8년…<br />어떻게 하면 인공지능이 사람을<br />뛰어 넘을 수 있을까 생각했습니다<br /><br />그렇기 때문에 알맹이만 인공지능과는<br />차원이 다릅니다
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="testimonial">
                    <div class="site-blocks-cover overlay" style="background:#1c1c1c;" data-aos="fade" id="home-section">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-10 mt-lg-5 text-center">
                                    <img src="{{config_item('new_landing_url')}}001/images/img_slide03_contents.png" class="img-fluid"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <div class="testimonial">
                    <div class="site-blocks-cover overlay" style="background:#f5f5f5;" id="home-section">
                        <div class="container">
                            <div class="row align-items-center justify-content-center">
                                <div class="col-md-10 mt-lg-5 text-center">
                                    <img src="{{config_item('new_landing_url')}}001/images/img_slide04_contents.png" class="img-fluid"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center  mt-5 mb-5">
                    <h2 class="section-title mb-3"><b>알파온</b>으로 당신의 계좌를 키워보세요</h2>
            ...
            <div class="row form-group">
                <div class="col-md-12 mb-5">
                    <form id="create-experience" method="post" action="/experience" onsubmit="return false;" class="p-3 bg-white">
                        ...
                        <input type="hidden" name="landing_num" id="landing_num" value="001">
