...
<div id="wrap">
	...
	<div id="container">
		<div id="content">
			<div class="title">
				<p>수익 실현 '폭풍 질주', 숨겨온 '비결' 전격 공개</p>
			</div>
			<div class="bx_date">
				 <p class="date">기사입력 <span></span></p>
			</div>
			<div class="bx_sub_text"><p>박스권에서도 높은 수익 기록<br />개인투자자들 위한 맞춤형 해결법 제공</p></div>
			<div class="bx_type">
				<img src="{{$landing_img_url}}img_document_1.png" alt="itbc stock 전문가 사진" />
				<span class="img_txt">최근 독보적인 수익률을 기록하며 돌풍을 일으키고 있는 itbcstock 전문가들 ⓒitbcstock</span>
				<p class="basic_txt pdtop_25">증시가 박스권에 갇히면서 개인투자자들의 손실이 이만저만 아니다. 특히 개인투자자들의 비중이 높은 바이오주와 대북경협 관련주, 중국관련주의 하락세가 이어지면서 어떻게 대처할지 몰라 발만 동동 구르고 있는 실정이다. </p>
				...
				<img src="{{$landing_img_url}}img_document_2.png" alt="itbcstock의 대표전문가 김재윤 전문가와 사근종 전문가가 방송을 하고 있다" />
				...
				<div>
					<div class="applyform02">
						<form id="create-experience2" method="post" action="/experience" onsubmit="return false;">
							...
							<div class="apply_title">itbcstock 제공<br /><b>오늘 사지 않으면 반드시 후회할 종목 받아보기</b></div>
							<div class="outwr">
