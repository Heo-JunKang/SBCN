...
@push('css')
    ...
    <style>
        ...
        .site-navbar .site-logo {
            ...
            width:262px;
            height:62px;
            background:url({{config_item('new_landing_url')}}008/images/main_logo.png)0 0 no-repeat;}
        ...
        .sticky-wrapper.is-sticky .site-navbar .site-logo a {
            ...
            width:262px;
            height:62px;
            background:url({{config_item('new_landing_url')}}008/images/main_logo_dark.png)0 0 no-repeat;}
...
@section('content')
                ...
                <div class="col-12 col-md-10 d-none d-xl-block">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            <li><a href="#team-section" class="nav-link">수익률</a></li>
                            <li><a href="#alphon-section" class="nav-link">방송속의 알파온</a></li>
                            <li><a href="#contact-section" class="nav-link">서비스 신청하기</a></li>
                        </ul>
                    </nav>
                </div>
    ...
    <!-- S : main  -->
    <div class="site-blocks-cover overlay" style="background-image: url({{config_item('new_landing_url')}}008/images/img_main_bg.jpg);" data-aos="fade" id="home-section">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-10 mt-lg-5 text-right">
                    <h1>
                        <span style="color:yellow">성공투자의 감동</span><br /><span style="color:red">인공지능 알파온과</span><br /><span>함께하지 않겠습니까</span>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <!-- S : mini DB -->
    <section class="section pb-0" style="background:#181818;" >
        <div class="container">
            <div class="row check-availabilty" id="next">
                <div class="block-32" data-aos="fade-up" data-aos-offset="-200">

                    <div class="row ">
                        <h3 class="dbtitle col-lg-12 text-center mb-5 mt_in">인공지능 포착 급등 예상 <span>종목 받기</span> </h3>
                    </div>
                    <form id="create-experience" method="post" action="/experience" onsubmit="return false;">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-lg-3 mb-3">
                                <label class="text-white" for="fname">이름</label>
                                <input type="text" id="name2" name="name" class="form-control" placeholder="이름을 입력해주세요">
                            </div>

                            <div class="col-md-5 col-lg-5 mb-3">
                                <label class="text-white" for="number">핸드폰번호</label>
                                <div class="row">
                                    <div class="col-sm-4 col-md-4 mb-3" style="padding-left:12px;">
                                    ...
                                    <div class="col-sm-4 col-md-4 mb-3" style="padding-right:15px;">
                                        <input type="text" name="pnum3" id="phone3" maxlength="4" class="col-md-12 form-control" pattern="\d*" numberOnly>
                                    </div>
                                </div>
                            </div>

                            <div class="col-md-4 col-lg-4 align-self-end form-group">
                                <input type="button" href="javascript:void(0);" onclick="post_experience();" value="신청하기" class="btn btn-primary btn-primary2 btn-block text-white">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <span class="labeltxt text-white"><b>전체동의하기</b></span>
                            </div>
                        </div>
                        <div class="row form-group">
                            @foreach($policy->contents->items as $v)
                                ...
                                <div class="privacy_title col-md-4 col-lg-4">
                                    ...
                                    <label for="mk-check-ver-0{{$v->policy_id}}" class="label_img" style="margin-top:19px;">
                                        <span class="labeltxt">{{$v->title}}({{$require_label}})<a href="/policies-{{$v->pc_id}}" target="_blank"> [보기]</a></span></label>
                                </div>
                            @endforeach
                        </div>
                    </form>
    ...
    <section>
        <div class="site-section cta-big-image" id="about-section" style="padding:0;">
            <div class="imgWrap" style="background:#181818;">
                <img src="{{config_item('new_landing_url')}}008/images/img_big_1.jpg" alt="Image" class="img-fluid">
            </div>
        </div>
    </section>
    <!-- E : contents 01  -->
    ...
    <!-- S : contents 02  -->
    <section class="site-section" style="background:#101551;" id="alphon-section">
        <div >
            <div class="mt-5 mb-5">
                <div class="col-12">
                    <h2 class="section-title mb-3 text-center">
                        걱정 마세요!<br />
                        itbcstock <span style="color:yellow;">인공지능</span> <span style="color:red;">알파온</span>이<br />
                        당신을 수익의 세계로 인도해드립니다
                    </h2>
                    <div class="imgWrap" style="padding:2rem 2rem 0 2rem">
                        <img src="{{config_item('new_landing_url')}}008/images/img_graph.png" alt="Image" class="img-fluid">
                        <img src="{{config_item('new_landing_url')}}008/images/img_capture.png" alt="Image" class="img-fluid">
                    </div>
                    <div>
                        <p class="col-md-12 text-center">한국경제TV 수익률 빅매치 종목별 수익률 1위 기록</p>
                    </div>
                </div>
            </div>
            <p class="col-md-12 text-center">개인의 투자시점과 투자성향에 따라 결과에 차이가 있을 수 있습니다</p>
        </div>
    </section>
    <!-- E : contents 02  -->
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-12 text-center">
                    <h2 class="section-title mb-3" style="color:#000;">알파온의 수익률은 차원이 다릅니다</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-6 mb-4 ">
                    <div class="team-member">
                        <figure>
                            <img src="{{config_item('new_landing_url')}}008/images/profit01.png" alt="Image" class="img-fluid">
                        </figure>
                    </div>
                </div>
                <div class="col-md-4 col-6 mb-4">
                    <div class="team-member">
                        <figure>
                            <img src="{{config_item('new_landing_url')}}008/images/profit02.png" alt="Image" class="img-fluid">
                        </figure>
                    </div>
                </div>
                <div class="col-md-4 col-6 mb-4">
                    <div class="team-member">
                        <figure>
                            <img src="{{config_item('new_landing_url')}}008/images/profit03.png" alt="Image" class="img-fluid">
                        </figure>
                    </div>
                </div>
                <div class="col-md-4 col-6 mb-4">
                    <div class="team-member">
                        <figure>
                            <img src="{{config_item('new_landing_url')}}008/images/profit04.png" alt="Image" class="img-fluid">
                        </figure>
                    </div>
                </div>
                <div class="col-md-4 col-6 mb-4">
                    <div class="team-member">
                        <figure>
                            <img src="{{config_item('new_landing_url')}}008/images/profit05.png" alt="Image" class="img-fluid">
                        </figure>
                    </div>
                </div>
                <div class="col-md-4 col-6 mb-4">
                    <div class="team-member">
                        <figure>
                            <img src="{{config_item('new_landing_url')}}008/images/profit06.png" alt="Image" class="img-fluid">
                        </figure>
                    </div>
                </div>
            </div>
            <div>
                <p class="col-md-12 text-center">
                    상승패턴 분석과 빠른 종목 포착으로 수익률에 있어 타의 추종을 불허합니다
                </p>
            </div>
            <p class="col-md-12 text-center">개인의 투자시점과 투자성향에 따라 결과에 차이가 있을 수 있습니다</p>
    </section>
    ...
    <section class="site-section border-bottom bg-light">
        <div class="container">
            <div class="row mb-5">
                <div class="col-12">
                    <h2 class="section-title mb-3 text-center" style="color:#000;">itbcstock은<span style="color:red";>성공투자의 감동을 공유합니다</span></h2>
                    <p class="col-md-12 text-center">itbcstock에서는 성공투자의 감동을 공유하기 위해 다양한 서비스를 고객들에게 제공해드리고 있습니다.</p>
                    <h3 class="section-sub-title pt-5 text-center"><b>itbcstock 인공지능 알파온 주요 제공 종목</b></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-25">
                    <div class=" box-with-humber">
                        <h5 class="text-black"><span style="color:#ec1d24; padding:0.25rem;">01.</span><b>급등주 포착</b></h5>
                        <p class="mb-4">급등이 예상되는 종목을 빠르게 잡아 내 고객들께 전합니다</p>
                    </div>
                </div>

                <div class="col-md-6 col-lg-25">
                    <div class=" box-with-humber">
                        <h5 class="text-black"><span  style="color:#ec1d24; padding:0.25rem;">02.</span><b>테마주 분석</b></h5>
                        <p class="mb-4">앞으로 큰 상승이 예상되는 테마주들을 추려내 고객들께 추천해드립니다</p>
                    </div>
                </div>

                <div class="col-md-6 col-lg-25">
                    <div class=" box-with-humber">
                        <h5 class="text-black"><span style="color:#ec1d24; padding:0.25rem;">03.</span><b>가치투자주 발굴</b></h5>
                        <p class="mb-4">장기적으로 회사실적이 좋아질 전망되는 종목들을 발굴해드립니다</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-25">
                    <div class=" box-with-humber">
                        <h5 class="text-black"><span  style="color:#ec1d24; padding:0.25rem;">04.</span><b>스윙주 발굴</b></h5>
                        <p class="mb-4">저점을 터치하고 상승이 예상되는 종목들을 발굴해 고객님께 알려드립니다</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-25">
                    <div class=" box-with-humber">
                        <h5 class="text-black"><span  style="color:#ec1d24; padding:0.25rem;">05.</span><b>공매도 탐색기</b></h5>
                        <p class="mb-4">공매도 물량의 움직임을 추적해 앞으로 상승가능성이 높은 종목을 발굴해드립니다</p>
                    </div>
                </div>
            </div>
        </div>
        <p class="col-md-12 text-center" style="margin-top: 30px;">개인의 투자시점과 투자성향에 따라 결과에 차이가 있을 수 있습니다</p>
    </section>
    <!-- E : contents 04 -->
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    <h2 class="section-title mb-3" style="color:#fff;">itbcstock의 <br />VIP서비스는 믿고 따라도 됩니다</h2>
                </div>
            </div>

            <div class="row">
                <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-center">
                    <div class="h-entry">
                        <img src="{{config_item('new_landing_url')}}008/images/img_cer_01.png" alt="Image" class="img-fluid">
                        <h2 class="font-size-regular" style="color:#fff;">금융위원회<br />알고리즘 인증</h2>
                    </div>
                </div>

                <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-center">
                    <div class="h-entry">
                        <img src="{{config_item('new_landing_url')}}008/images/img_cer_02.png" alt="Image" class="img-fluid">
                        <h2 class="font-size-regular" style="color:#fff;">기술보증기금<br />벤처기업 확인서</h2>
                    </div>
                </div>

                <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-center">
                    <div class="h-entry">
                        <img src="{{config_item('new_landing_url')}}008/images/img_cer_03.png" alt="Image" class="img-fluid">
                        <h2 class="font-size-regular" style="color:#fff;">기업부설연구소<br />인증</h2>
                    </div>
                </div>

                <div class="col-6 col-md-6 col-lg-3 mb-4 mb-lg-4 text-center">
                    <div class="h-entry">
                        <img src="{{config_item('new_landing_url')}}008/images/img_cer_04.png" alt="Image" class="img-fluid">
                        <h2 class="font-size-regular" style="color:#fff;">창업지원사업<br />선정</h2>
                    </div>
                </div>
            ...
            <div class="text-center bg-white">
                <div>
                    <a href="http://www.edaily.co.kr/news/news_detail.asp?newsId=01984406616093576&mediaCodeNo=257" target="_blank" ><img src="{{config_item('new_landing_url')}}008/images/img_cer_05.png" alt="Image" class="img-fluid"></a>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="row form-group">
                <div class="col-md-12 mb-5">
                    <form id="create-experience" method="post" action="/experience" onsubmit="return false;" class="p-3 bg-white">
                        ...
                        <input type="hidden" name="expert" value="itbcstock" />
                        <input type="hidden" name="ca_name" id="cate" value="{{$cate}}">
                        <input type="hidden" name="landing_num" id="landing_num" value="008">
