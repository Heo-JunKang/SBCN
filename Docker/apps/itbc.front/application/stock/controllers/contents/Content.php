...
class Content extends View
{
     ...
     */
    public function index($id,$cate_id)
    {
        ...
        $items['article']   = json_decode($this->lib_api->call('get', '/contents/article',['page'=>1,'per_page'=>10,'enabled'=>'y','cc_id'=>'expert-activity','store_id'=>$id]));
