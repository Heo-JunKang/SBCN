...
(function(exports, $){
    ...
    */
    ...
    function header() {
        ...
        var blueBannerHei = $('.top-onair-quick-wrap').height();

        // var fix = scroll_val > (headerHei + top_banner_height) - headerHei;
        var fix = scroll_val > blueBannerHei;
        ...
        if(fix) {
            ...
            // $('.side-quick-banner-fix').addClass('down');
            $('.economy-lab-wrap').addClass('down');
        }else{
            $('#header').css({
                'position': 'absolute',
            ...
            // $('.side-quick-banner-fix').removeClass('down');
            $('.economy-lab-wrap').removeClass('down');
        }
    }
    ...
    function smsDetailList() {
        $(".sms-detail-scroll").mCustomScrollbar({
            theme:"dark"
        });
    }

    function sideQuick() {
        $('.swich-tele-a').on('click', function(){
            $('.quick-telegram').toggleClass('on');
        });
    }
