...
?>
<div class="sub_page mobile_contract">
    <div>
    <div style="overflow:hidden;">
        <div class="side_contents" style="width:100%">
			<div class="sub_detail">
            	<p class="title">투봇 이용 서비스</p>
                <div class="contents">
					<div class="service_list" style="border: solid 1px #a49293;">
						<a onclick="return false;">
							<div class="info_1" style="">
								<h4 style="width:100%; font-weight:bold;padding-left:0;">투봇</h4>
								<div class="info_detail_1" style="margin-left:0; padding-top:15px;">
							...
							<div class="info_2" style="width:100%;">
								<div class="service_period">
									<p>유료결제 기간<span>0일</span></p>
									<p>무료서비스 기간<span>0일</span></p>
								</div>
								<div class="expiry_date">
									<p>총 잔여 이용 기간<span>0일</span></p>

								</div>
							</div>
						</a>
					</div>
					<div class="fees_info" style="">
					...
					<div class="contract">
						<div style="line-height: 25px; padding: 16px;background-color:#f1f1f1;margin-top:16px; word-break: break-all; width:100%;box-sizing:border-box; height: 300px; overflow-y:scroll;font-size:14px;">
							<table width="100%" align=center>
							<!-- <tr bgcolor=black><td><a href=# onclick="history.go(-1);"><font color=white><b style="font-size:24px;">&nbsp; ← 뒤로 가기</b></font></a></td></tr> -->
							<tr><td><br />
							<p style="font-size:20px; font-weight: bold; text-align: center;">계&nbsp;&nbsp;약&nbsp;&nbsp;서</p>
							<b>제1조 [당사자]</b><br />
							<u>홍길동</u>(이하 “회원”이라 한다)과 ㈜<?=$default['de_admin_company_name']; ?>(이하 “회사”라 한다)은 다음과 같은 내용으로 계약을 체결한다.<br /><br />

							<b>제2조 [계약내용]</b><br />
							회원은 회사가 운영 중인 웹사이트(이데일리투봇)의 주식분석 전문가 그룹의 주식 종목 매수 및 매도 문자 제공 유료 서비스를 제4조의 기간 동안 받을 권리를 갖는다.<br /><br />
							<b>제3조 [계약금액]</b><br />
							회원은 제2조 및 제3조에 대한 비용으로 정상이용금액 일금  <u>이천사백만원(￦24,000,000원)</u>을 당사 이벤트 적용 금액 <u>일금 원(￦0원)</u>으로 결제한다.<br />
							<br />
							...
							<br /><br />
							<p style="text-align: center;"><?=date("Y년 m월 d일");?></p><br />

							회원성명 : 홍길동<br />
							전화번호 : 010-0000-0000<br /><br />

							회사상호 : <?=$default['de_admin_company_name']; ?><br />
                    ...
                    <p style="text-align:left; margin:0 16px; color:#a49293; font-size:15px;">이용서비스 상세</p>

                    <div class="service_list" style="border: solid 1px #a49293; margin:16px;">
						<a onclick="return false;" style="padding:16px 0;width:100%;height:auto;">
							<div class="info_1" style="margin-right:0; border: 0;">
								<h4 style="width:100%;padding-left:16px;">투봇 <span class="lt">로켓마스터</span><br><span style="font-size:0.5em;font-size: 18px;font-weight:normal;">공격적이고 단기적인 포트폴리오</span></h4>
								<div class="info_detail_1" style="margin-left:16px;">
									<p>미래를 바라보고 큰 그림을 그린다!<br>성장 가능성 무궁무진한 대세 종목 선취매 후 편하게 수익 실현!</p>
								</div>
								<div class="info_detail_2" style="margin-left:16px;">
									<span class="title">세부전략</span>
									<p>IT, 바이오, 전기 수소차 등 시장 턴어라운드 예상테마 선점</p>
								</div>
							</div>
						</a>
					</div>
