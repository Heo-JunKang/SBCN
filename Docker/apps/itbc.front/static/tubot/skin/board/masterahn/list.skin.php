...
?>
		...
		<!-- contents -->
		<div align="center">
			<img src="/<?=G5_THEME_DIR?>/tubot/skin/board/masterahn/img/Tubot_master_ahn.jpg" alt=""style="margin-bottom:220px;">
			<div style="position:absolute; bottom:8.5%;left:50%;margin-left:-157px;">
				<a href="/bbs/write.php?bo_table=board12&item_id=23" style="  width: 313px;height: 45px;border-radius: 3px;background-color: #f63440;">
