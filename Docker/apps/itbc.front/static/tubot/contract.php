                ...
                <div class="contents">
					...
					<div class="contract">
						...
						<div style="line-height: 25px; padding: 30px; word-break: break-all; width:100%;box-sizing:border-box; height: 300px; margin-bottom: 70px; overflow-y:scroll;">
							...
							(1) 본 계약 체결 후 주식 종목 매수 문자를 받은 이후 단순 변심에 의한 해지 또는 이용 도중 중도 해지를 요청하는 경우에는 본 계약 체결 후 7일 이전에는 이용일수에 해당하는 금액만 부과하며, 7일이 경과한 경우에는 해지일까지 이용일수에 해당하는 금액과 잔여기간 이용요금의 10%를 별도 위약금으로 부과한다.<br />
							...
							회원&emsp;&emsp;&nbsp;성&emsp;&emsp;명 : 홍길동<br />
							&emsp;&emsp;&emsp;&emsp;&nbsp;전화번호 : 010-0000-0000<br /><br />
                    ...
                    <div class="service_list" style="border: solid 1px #a49293; margin: 20px 0 50px 0;">
						<a onclick="return false;" style="width:781px;padding:20px 0;">
							<div class="info_1" style="width:580px;margin-right:20px; border: 0;">
								<h4 style="width:100%;padding-left:20px;">투봇 <span class="lt">로켓마스터</span><span style="font-size:0.5em;font-size: 18px; margin-left: 10px;font-weight:normal;">공격적이고 단기적인 포트폴리오</span></h4>
								<img src="http://tubot.co.kr/data/file/service/thumb-990568001_LkRuj2dT_0830c6a46451c285b60eb7f27ece7473eec59e9d_224x142.png" style="top:80px">
